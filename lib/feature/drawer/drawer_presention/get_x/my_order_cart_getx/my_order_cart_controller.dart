...
class MyOrderCartController extends GetxController{
...
MyOrderCartController({required this.image,required this.confirmOrderUseCase,required this.deleteOrderDetailUseCase,required this.getMedcineCartUseCase,required this.getProductCartUsecase,required this.sendRachetaImageUseCase});
